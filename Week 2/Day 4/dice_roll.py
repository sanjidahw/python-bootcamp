...
print(f"The probability of 1 = {(two_counter/N) * 100}%")
print(f"The probability of 1 = {(three_counter/N) * 100}%")
print(f"The probability of 1 = {(four_counter/N) * 100}%")
print(f"The probability of 1 = {(five_counter/N) * 100}%")
print(f"The probability of 1 = {(six_counter/N) * 100}%")

def monte_carlo_with_lists(N,dice_max=6):
	results = []
	for exp in rnage(0,N):
