class wheel:
	...
	# init is the constructor function. self means that it's a method of the class
		self.size = diameter #these are attributes(descriptions) of the class
		self.type = wtype
